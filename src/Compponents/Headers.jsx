...
<strong>
<h1 className='text-center'>Singup,Login to Daily <FcCalendar /> dress colour suggetion </h1></strong>
<section id="about" className="bg-light py-5">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6">
          <img src="https://mymyindia.com/data/insta_images/mymyahmedabad/2961143286312427712.jpg" alt="Profile Image" class="img-fluid"></img>
        </div>
      </div>
    </div>
  </section>
  ...
  <section id="Treditional" class="bg-light py-5">
    <div class="container">
      <h2 class="text-center mb-4"> Tredional</h2>
     <h3 class="text-center mb-3">
      Kurtas For Womes</h3>
      <div class="row">
        <div class="col-lg-4 mb-4">
          <div class="card">
            <img src="	https://zola.in/cdn/shop/files/358730Pink_1_1800x1800.jpg?v=1685712494" alt="Project 1" class="card-img-top"></img>
            <div class="card-body">
              <h5 class="card-title">Pink Straight Kurta Set For Women  </h5>
            </div>
          </div>
        </div>
        <div class="col-lg-4 mb-4">
          <div class="card">
            <img src="		https://janasya.com/cdn/shop/files/JNE4157-KR.jpg?v=1685621206" alt="Project 1" class="card-img-top"></img>
            <div class="card-body">
              <h5 class="card-title">Pink Dobby Chiffon Self Design Empire Kurta </h5>
            </div>
          </div>
        </div>
        <div class="col-lg-4 mb-4">
          <div class="card">
            <img src="		https://janasya.com/cdn/shop/files/JNE4022-KR_3.jpg?v=1686055935" alt="Project 1" class="card-img-top"></img>
            <div class="card-body">
              <h5 class="card-title">Yellow Cambric Cotton Printed Straight Kurta </h5>
            </div>
          </div>
        </div>
        <div class="col-lg-4 mb-4">
          <div class="card">
            <img src="	https://janasya.com/cdn/shop/files/JNE4026-KR.jpg?v=1685788572" alt="Project 1" class="card-img-top"></img>
            <div class="card-body">
              <h5 class="card-title">Purple Cotton Batik Print Straight Kurta</h5>
            </div>
          </div>
        </div>
        <div class="col-lg-4 mb-4">
...
" alt="Project 1" class="card-img-top"></img>
            <div class="card-body">
              <h5 class="card-title">Pink Poly Chiffon Self Design Frontslit Kurta </h5>
            </div>
          </div>
        </div>
        <div class="col-lg-4 mb-4">
...
" alt="Project 1" class="card-img-top"></img>
            <div class="card-body">
              <h5 class="card-title">Wine Poly Chiffon Self Design Frontslit Kurta </h5>
            </div>
          </div>
        </div>
      </div>
